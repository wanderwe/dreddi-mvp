...
test("open deals do not reset streak because only closed deals are counted", () => {
  const streak = computeDealStreak([
    { status: "active", updated_at: "2024-05-06T10:00:00.000Z" },
    { status: "completed_by_promisor", updated_at: "2024-05-05T10:00:00.000Z" },
    { status: "confirmed", confirmed_at: "2024-05-04T10:00:00.000Z" },
    { status: "confirmed", confirmed_at: "2024-05-03T10:00:00.000Z" },
  ]);
