-- Fix "column reference id is ambiguous" in admin_list_feedback/disputes/users:
-- their RETURNS TABLE includes an `id` column, which collided with the
-- unqualified `id` in the admin_users authorization check.
