-- The INSERT ... ON CONFLICT (id) inside admin_add_admin collides with the
-- implicit `id` output variable from RETURNS TABLE(id uuid, ...), causing
-- "column reference id is ambiguous" (42702). Tell PL/pgSQL to prefer table
-- columns over variables on ambiguous references.
