-- Restore public profile reputation aggregates across all reputation-bearing deals.
-- Public deal rows remain restricted by public_get_profile_public_promises; this view exposes
-- aggregate counts only so the public profile matches the user's reputation dashboard.
