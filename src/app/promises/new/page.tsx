  ...
  const reasonText = useMemo(
    () =>
      ({
        ...
        low_dispute_rate: t("promises.new.prediction.reasons.lowDisputeRate"),
        ...
        counterparty_high_fulfillment: t("promises.new.prediction.reasons.counterpartyHighFulfillment"),
        counterparty_low_fulfillment: t("promises.new.prediction.reasons.counterpartyLowFulfillment"),
