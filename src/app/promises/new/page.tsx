        ...
        <div className="w-full max-w-2xl space-y-5 rounded-3xl border border-white/10 bg-black/40 p-5 pb-28 shadow-2xl shadow-black/40 backdrop-blur sm:p-8 sm:pb-8">
          ...
          <div className="grid items-start gap-5 sm:grid-cols-2">
            <div className="space-y-2 text-sm text-slate-200 sm:col-span-2">
              ...
              <p className="text-xs text-slate-400">{t("promises.new.fields.executorHelper")}</p>
            </div>
            ...
            <div className="sm:col-span-2">
              ...
              >
                {isSecondaryExpanded
                  ? t("promises.new.actions.hideSecondary")
                  : t("promises.new.actions.showSecondary")}
                <ChevronDown
                  className={clsx("h-3.5 w-3.5 transition-transform", isSecondaryExpanded && "rotate-180")}
                  aria-hidden
                />
              </button>
            </div>
              ...
              <>
                <label className="space-y-2 text-sm text-slate-200 sm:col-span-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Tooltip label={t("promises.new.fields.groupHelperTooltip")} placement="top">
                      <span
                        aria-label={t("promises.new.fields.groupHelperTooltip")}
            ...
            {isSecondaryExpanded && shouldShowCondition && (
              <label className="space-y-2 text-sm text-slate-200 sm:col-span-2">
                <span className="block text-xs uppercase tracking-[0.2em] text-emerald-200">
          ...
          <div className="space-y-3">
            <p className="text-xs text-slate-400">{t("promises.new.agreementHint")}</p>
            <button
