            ...
            <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-slate-200">
              <div className="flex items-center gap-3">
                <div className="min-w-0 flex-1 space-y-1">
                  ...
                  <p className="text-xs text-slate-400">
                    {isPublicProfile === false
                      ? t("profile.settings.publicHelper")
                ...
                <button
                  ...
                  onClick={() => {
                    if (isPublicProfile === false) return;
                    setIsPublicDeal((prev) => !prev);
                  }}
                  disabled={isPublicProfile === false}
                  className={`relative inline-flex h-6 w-11 flex-shrink-0 items-center rounded-full border transition ${
                    ...
                    isPublicProfile === false ? "cursor-not-allowed opacity-60" : "cursor-pointer"
                  }`}
                >
                  <span
