    ...
    <section className="relative mx-auto w-full max-w-6xl px-4 pb-20 sm:px-6">
      ...
      <div className="relative grid items-start gap-10 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
        ...
        <div className="flex flex-col gap-6">
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 via-black/20 to-emerald-500/5 p-6 shadow-inner shadow-black/40">
            ...
            <p className="mt-3 text-sm text-slate-300">{copy.profileDescription}</p>
          </div>
