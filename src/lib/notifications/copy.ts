...
const copyByLocale: Record<NotificationLocale, Record<NotificationType, NotificationCopy>> = {
  en: {
    ...
    reminder_manual: {
      title: "Reminder",
      body: "The other side sent a reminder. Open the agreement and take the next step.",
      ctaLabel: "Open",
    },
    completion_waiting: {
      title: "Action needed",
  ...
  uk: {
    ...
    reminder_manual: {
      title: "Нагадування",
      body: "Інша сторона надіслала нагадування. Відкрийте угоду та виконайте наступну дію.",
      ctaLabel: "Відкрити",
    },
    completion_waiting: {
      title: "Потрібна дія",
