...
export const landingCopy: Record<Locale, LandingCopy> = {
  uk: {
    hero: {
      eyebrow: "Між розмовою і контрактом — ви фіксуєте домовленості",
      headline: "Домовленість починається з підтвердження",
      description:
        "Dreddi допомагає фіксувати домовленості,\nбрати відповідальність і будувати репутацію.\nБез юридичного тиску — але з реальними наслідками для довіри.",
    },
    cta: {
  ...
  en: {
    hero: {
      eyebrow: "Between talk and contracts — you capture agreements",
      headline: "An agreement starts with confirmation",
      description:
        "Dreddi helps you capture agreements,\ntake responsibility, and build reputation through outcomes.\nNo legal pressure — but real consequences for trust.",
    },
    cta: {
